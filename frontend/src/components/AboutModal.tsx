      ...
      {isOpen && (
        ...
        <div className="px-6 py-3 space-y-4 max-h-[70vh] overflow-y-auto">
          ...
          <div className="space-y-2 mt-4">
            <h4 className="text-sm font-semibold text-gray-900 dark:text-white">{t('about.datasetInfo.label')}</h4>
            <p className="text-xs text-gray-600 dark:text-gray-400 font-light leading-relaxed">
              {t('about.datasetInfo.description')}
            </p>
          </div>
        ...
        <div className="px-6 py-4 bg-gray-50 dark:bg-gray-700/50 border-t border-gray-200 dark:border-gray-700">
          <p className="text-xs font-semibold text-gray-700 dark:text-gray-300 text-center mb-1">
            {t('about.authors.title')}
          </p>
          <p className="text-xs text-gray-600 dark:text-gray-400 text-center mb-3">
            {t('about.authors.list')}
          </p>
